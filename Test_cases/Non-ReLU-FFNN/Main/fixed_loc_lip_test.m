...
loc_lip  =  Lip_Verify_threshold( net, border, lb, ub, method_Trajectory, method_STL, LipSDP_type , 12.5 );
[decision, Letsgo, counter_example]  =  Lip_Verify_lip_fixed( net, border, lb, ub, [2 , 2], method_Trajectory, method_STL, LipSDP_type , loc_lip );
Running_time=toc;
