...
%%% Until2
cell_1st = F_operation(cell_P4,    12,16);
cell_2nd = and_operation(cell_1st, cell_P2);
cell_3rd = F_operation(cell_2nd,    6, 11);
cell_4th = and_operation(cell_3rd, cell_P1);
cell_5th = F_operation(cell_4th,    5, 8);
